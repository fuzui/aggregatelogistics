...
public class InitConfig {
  ...
  public static ExpressConfig getConfig() {
    ...
    if (bundle.containsKey("express.sf.partnerID") && bundle.containsKey("express.sf.requestID")
      && bundle.containsKey("express.sf.checkWord") && bundle.containsKey("express.sf.isProduct")) {
    ...
    // 百世
    if (bundle.containsKey("express.htky.partnerID") && bundle.containsKey("express.htky.secretKey")
    ...
    if (bundle.containsKey("express.yto.appkey") && bundle.containsKey("express.yto.secretKey")
      && bundle.containsKey("express.yto.userId") && bundle.containsKey("express.yto.isProduct")) {
    ...
    // 中通
    if (bundle.containsKey("express.zto.companyId") && bundle.containsKey("express.zto.secretKey")
